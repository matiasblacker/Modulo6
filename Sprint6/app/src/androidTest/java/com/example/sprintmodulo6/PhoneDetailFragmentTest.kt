...
class PhoneDetailFragmentTest {
    ...
    @Test
    fun testPhoneDetailsApi() {
        // Arrange: Se configura el MockWebServer para obtener una URL de prueba
        val expectedBaseUrl = mockWebServer.url("/").toString() // Asegúrate de usar .toString()
        ...
        // Aquí se podrían agregar más verificaciones, como las respuestas simuladas del servidor
    }
}